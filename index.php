<?php require_once("includes/head.php");?>
    ...
    <nav class="navbar navbar-dark bg-dark fixed-top">
        <a class="navbar-brand" href="index.php">
            <img src="img/logounsch.png" width="30" height="30" class="navbar-logo d-inline-block align-top" alt="">
            <h1 class="navbar-title">Desarrollo Web-UNSCH</h1>
        </a>
    </nav>
    <header class="header">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <h2>Instructor: Mag. Ing. Hubner Janampa Patilla</h2>
                </div>
                <div class="col-12">
        ...
        <div class="container border-radius">
                            ...
                            <div class="row form-container-margin">
                                ...
                                <div class="col-12 col-md-6">
                                    <input type="text" name="direccion" id="direccion" class="form-control"
                                        pattern="[A-Za-z0-9]+" placeholder="Su dirección" required>
                                </div>
                            </div>
                            ...
                            <div class="row form-container-margin">
                                ...
                                <div class="col-12 col-md-6">
                                    <input type="tel" name="telefono" id="telefono" class="form-control"
                                        pattern="[0-9]+" placeholder="Su telefono" required>
                                </div>
                            </div>
                        </div>
                    </fieldset>
                ...
                <div class="col-12">
                    <fieldset>
                        ...
                        <div class="container">
                                <div class="row form-container-margin">
                                    <div class="col-12 col-md-2 offset-md-1 texto-form">
                                        <label for="condiciones">Apruebo las condiciones de servicio [Condiciones de servicio]<em>*</em></label>
                                    </div>
                                    <div class="col-12 col-md-6">
            ...
            <div class="row">
                <div class="col-12 text-center">
                    <button type="submit" class="btn btn-secondary btn-enviar btn-lg">Enviar</button>
                </div>
            </div>
        </div>
    </form>
