...
<?php
    // google recaptcha
    $public_key = "6LekQb4UAAAAADNbOAv_SSfFkaX-yYMewZlwv2aY";
    $private_key = "6LekQb4UAAAAAJo3XRr4hEyhj1OBLRnhFwUX0SQ4";
    ...
    if(isset($_POST['enviar'])){
        ...
        $confirm_contra = $_POST['confirmar_contrasenia'];
        $nombre = $_POST['nombre'];
        ...
        $terminos = $_POST['condiciones'];
        
        // echo $correo  . "<br>";
        // echo $usuario . "<br>";
        // echo $contrasenia . "<br>";
        // echo $confirm_contra . "<br>";
        // echo $nombre . "<br>";
        // echo $apellido . "<br>";
        // echo $dni . "<br>";
        // echo $direccion . "<br>";
        ...
        if($contrasenia == $confirm_contra) {
            //password validation
            $pattern_up = "/^.*(?=.{4,56})(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9]).*$/";
            if(!preg_match($pattern_up, $contrasenia)) {
                $errPass = "la contraseña debe tener un tamaño de 4, 1 mayuscula, 1 minuscula y 1 letra";
            }
        } else {
        ...
        if($terminos == 'on'){
            ...
            $terminos = 0;
            $errTerm = "debe aceptar los terminos";
        }

        // insertando datos
        // if(!isset($errPass) && !isset($errTerm) && !isset($errCaptcha))
        if(!isset($errPass) && !isset($errTerm)) {
            $hash = password_hash($contrasenia, PASSWORD_BCRYPT, ['cost'=>10]);
            
            $query = "INSERT INTO usuarios (correo, usuario, contrasenia, confirm_contra, nombre, apellido, dni, direccion, pais, telefono, terminos) VALUES ('$correo','$usuario','$hash','$hash','$nombre','$apellido','$dni','$direccion','$pais','$telefono','$terminos')";
...
<form action="index.php" method="post">
    <div class="container border-radius">
        <p class="form-text-header">[*Necesario]</p>
        <div class="row">
            <div class="col-12">
                <fieldset>
                    <legend>Información del cliente</legend>
                    <div class="container">
                        <div class="row form-container-margin">
                            <div class="col-12 col-md-2 offset-md-1 texto-form">
                        ...
                        <div class="row form-container-margin">
                            <div class="col-12 col-md-2 offset-md-1 texto-form">
                                <label for="usuario">Nombre de usuario <em>*</em></label>
                            </div>
                            <div class="col-12 col-md-6">
                        ...
                        <div class="row form-container-margin">
                            <div class="col-12 col-md-2 offset-md-1 texto-form">
                                <label for="contrasenia">Contraseña <em>*</em></label>
                            </div>
                            <div class="col-12 col-md-6">
                        ...
                        <div class="row form-container-margin">
                            <div class="col-12 col-md-2 offset-md-1 texto-form">
                                <label for="confirmar_contrasenia">Confirmar Contraseña <em>*</em></label>
                            </div>
                            <div class="col-12 col-md-6">
                ...
                <fieldset>
                    ...
                    <div class="container">
                        <div class="row form-container-margin">
                            ...
                            <div class="col-12 col-md-6">
                                <input type="text" name="nombre" placeholder="Su nombre" maxlength="40" required
                        ...
                        <div class="row form-container-margin">
                            ...
                            <div class="col-12 col-md-6">
                                <input type="text" maxlength="8" name="dni" id="dni" class="form-control"
                                    pattern="[0-9]+" placeholder="xxxxxxxx" required>
                            </div>
                        </div>

                        <div class="row form-container-margin">
                            <div class="col-12 col-md-2 offset-md-1 texto-form">
                                <label for="direccion">Dirección<em>*</em></label>
                            </div>
                            <div class="col-12 col-md-6">
                        ...
                        <div class="row form-container-margin">
                            <div class="col-12 col-md-2 offset-md-1 texto-form">
                                <label for="pais">País<em>*</em></label>
                            </div>
                            <div class="col-12 col-md-6">
                        ...
                        <div class="row form-container-margin">
                            ...
                            <div class="col-12 col-md-6">
                                <input type="tel" name="telefono" id="telefono" class="form-control" pattern="[0-9]+"
                                    placeholder="Su telefono" required>
                            </div>
                        </div>
                    </div>
                </fieldset>
        ...
        <div class="row">
            <div class="col-12">
                <fieldset>
                    <legend>Enviar registro</legend>
                    <div class="container">
                        <div class="row form-container-margin">
                            <div class="col-12 col-md-2 offset-md-1 texto-form">
                                <label for="condiciones">
                                    <span class="terminos">Apruebo las condiciones de servicio [Condiciones de
                                        servicio]<em>*</em></span>
                                </label>
                            </div>
                            <div class="col-12 col-md-3">
                                <input type="checkbox" name="condiciones" required>
                                <?php echo isset($errTerm)?"<span class='error'>{$errTerm}</span>":"";
                                ?>
                            </div>
                            <div class="col-12 col-md-3">
        ...
        <div class="row">
            <div class="col-12 text-center">
                <input type="submit" class="input-submit btn btn-secondary btn-enviar" value="ENVIAR" name="enviar">
            </div>
        </div>
    </div>
</form>
